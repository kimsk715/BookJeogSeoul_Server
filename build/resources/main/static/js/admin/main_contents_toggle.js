...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const pages = {
    ...
    bookDonate : document.querySelectorAll(".book-donate-management"),
    ...
    sponsorInquiry : document.querySelectorAll(".sponsor-inquiry-management"),
  ...
  const pageLinks = {
    ...
    bookDonate : document.querySelectorAll(".book-donate-link"),
    ...
    sponsorInquiry : document.querySelectorAll(".sponsor-inquiry-link"),
